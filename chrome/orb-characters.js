...
const OrbTuning = (() => {
  ...
  function apply() {
    ...
    // Refresh calibration overlay live whenever tuning values are applied
...
// ============================================================================
// COMPLETION MODAL — result overlay shown on export done / cancel
// Renders inside #piqResultCard which lives inside .piq-orb-sphere.
// ============================================================================
...
const OrbController = (() => {
  ...
  return { show, hide, onCancel, setDone, say, announce, addError, setCount, setCurrentName, setMeta, logResult, applySvgFaces, showResult };
})();
